...
public class FurumaRoom extends FurumaResort{
    private String freeService;

    public FurumaRoom(String nameService, String areaUse, String rentType, int feeRent, int amountCustomer, String freeService) {
        super(nameService, areaUse, rentType, feeRent, amountCustomer);
    ...
    public FurumaRoom(String nameService, String areaUse, String rentType, String standardService, int floor, int feeRent, int amountCustomer) {
